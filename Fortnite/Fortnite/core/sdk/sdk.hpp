...
#define LOG(...) \
 std::printf( hash_str( "[flaw-fn-build] " ), __FUNCTION__ ); \
...
//read_args.push_back( { actor_array.get_address( ), ent.data( ), actor_array.size( ) * sizeof( fortnite::a_fort_player_state_athena ) } );
